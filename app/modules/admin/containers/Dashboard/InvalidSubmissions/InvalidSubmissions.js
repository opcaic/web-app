...
} from '@/modules/admin/ducks/invalidSubmissions';
...
class InvalidSubmissions extends React.Component {
  fetchItems = additionalParams => {
    const params = Object.assign({}, additionalParams, {
      validationState: submissionValidationStateEnum.INVALID,
      managedOnly: true,
    });
  ...
  render() {
    return (
      <Card
        title={<FormattedMessage id="app.admin.dashboard.invalidSubmissions" />}
        bodyStyle={{ padding: 0 }}
      >
        <CardTable>
